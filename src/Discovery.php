...
//        if ($cache) {
//            //获取当前服务名的缓存
//            $value = $this->cacheClient->get($this->keyProfix.$serviceName);
//            if ($value) {
...
//            $this->cacheClient->setex($this->keyProfix.$serviceName, 600, $service);//10min缓存失效时间
//        }
    ...
    public function clearCache($serviceNames, $all = false)
    {
        ...
        //redis
        if ($all) {
            $res = $this->cacheClient->del($this->keyProfix.'*');
        } else {
